...
public enum GameTypes {
    UNDEFINED("Undefined", MinigameArena.class, MiniGame.class, ArenaEditGui.class, new String[]{"8", "10", "20", "10", "false", "false"}),
    SPLEEF("Spleef", SpleefArena.class, SpleefGame.class, SpleefArenaEditGui.class, new String[]{"2", "2", "0", "10", "true", "false", "1", "WHITE_WOOL"});
